...
import ys.mobile.finoteapp.ui.auth.RegisterScreen
...
sealed class Screen(val route: String, val label: String, val icon: ImageVector) {
    ...
    data object Register : Screen("Register", "Register", Icons.Filled.PersonAdd)
...
fun AppNavHost(
    ...
    NavHost(
        ...
        composable(Screen.Login.route) {
            ys.mobile.finoteapp.ui.auth.LoginScreen(
                onLoginSuccess = {
        ...
        composable(Screen.GoalTracker.route) {
            ys.mobile.finoteapp.ui.goal.GoalPage(
                onGoalClick = { goalId ->
                    navController.navigate("goal/detail/$goalId")
                },
                navController = navController
            )
        }
        ...
        composable(
            ...
            if (goalId != null) {
                ys.mobile.finoteapp.ui.goal.GoalDetailScreen(
                    goalId = goalId,
